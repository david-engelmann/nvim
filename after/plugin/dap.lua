...
dap.configurations.c = {
  ...
  --   type = "lldb",
  --   request = "launch",
  --   program = "~/sourcegraph/rust-analyzer.git/monikers-1/target/debug/rust-analyzer",
  --   args = { "lsif", "~/build/rmpv/" },
  --   cwd = "~/sourcegraph/rust-analyzer.git/monikers-1/",
  --   stopOnEntry = false,
  --   runInTerminal = false,
  -- },
  {
    ...
    type = "lldb",
    request = "launch",
    program = "~/build/neovim.git/lua_autocmd/build/bin/nvim",
    args = { "--headless" },
    cwd = "~/build/neovim.git/lua_autocmd/",
    stopOnEntry = false,
    runInTerminal = false,
  },
}
...
dap.configurations.go = {
  ...
  },
  {
    ...
    program = "./cmd/lsif-go",
    args = {
      "--project-root=~/sourcegraph/smol_go/",
      "--repository-root=~/sourcegraph/smol_go/",
      "--module-root=~/sourcegraph/smol_go/",
  ...
  },
  {
    ...
    program = "./cmd/lsif-go",
    args = {
      "--project-root=~/sourcegraph/sourcegraph.git/main",
      "--repository-root=~/sourcegraph/sourcegraph.git/main",
      "--module-root=~/sourcegraph/sourcegraph.git/main",
      "--no-animation",
    },
    dlvToolPath = vim.fn.exepath "dlv",
  },
