...
local autocmd = require("david.auto").autocmd
...
local inlays = require "david.lsp.inlay"
...
local filetype_attach = setmetatable({
  ...
  ocaml = function()
    ...
    autocmd {
      ...
      augroup_codelens,
      require("david.lsp.codelens").refresh_virtlines,
      0,
    }
    ...
    vim.keymap.set(
      "n",
      "<space>tt",
      require("david.lsp.codelens").toggle_virtlines,
